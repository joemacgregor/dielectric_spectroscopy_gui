...
MATLAB scripts/functions/GUIs/datasets for reading, homogenizing and analyzing dielectric spectroscopy data collected by the Solartron platform. Optimized for analyzing ice-rich materials, but potentially adjustable to other materials. 
